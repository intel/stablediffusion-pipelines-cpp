...
namespace cpp_stable_diffusion_ov
{
    ...
    class UNetLoopSD15InternalBlobs : public UNetLoop
    {
    public:

        UNetLoopSD15InternalBlobs(std::string model_dir,
    ...
    private:
        ...
        ov::InferRequest _unet_time_proj_request;

        bool _bneeds_time_constants = false;
        ov::Tensor _time_constants;
        ov::Tensor _sin_t;
        ov::Tensor _cos_t;

        void _run_unet_async(ov::Tensor time_proj, ov::Tensor latents, int64_t timestep, ov::Tensor encoder_hidden_states, size_t infer_request_index);
